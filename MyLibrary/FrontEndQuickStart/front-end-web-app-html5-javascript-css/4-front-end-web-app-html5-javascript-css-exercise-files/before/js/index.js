...
$("#getHubSearchForm").on("submit", function(){
	...
	if(searchPhrase){
		...
		resultList.text("Performaing searching...");
...
// //$("header nav li").text("Testing jQuery");//manipulate wrapped set
// //$("header nav li").css("font-weight", "bold"); //manipulate CSS, nontrivial
// var listItems = $("header nav li");
// listItems.css("font-weight", "bold");
// listItems.css("font-size", "18px");
// //$("header nav li:first").css("font-size", "18px");//are not a trival effort, instead, use line below:
// listItems.filter(":first").css("font-zie", "18px");
