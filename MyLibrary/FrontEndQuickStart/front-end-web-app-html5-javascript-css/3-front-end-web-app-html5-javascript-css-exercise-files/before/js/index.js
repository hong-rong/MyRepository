...
console.log(msg);
var resultsDev = document.getElementById("results");
resultsDev.innerHTML = "<p>This is from JavaScript</p>";
...
// console.log(result.phoneNubmer);
var results = [{
	name: "jQuery",
	language: "JavaScript",
	score: 4.5,
...
// console.log("resultsDiv is " + typeof(msg));
...
// function testMe(){
	...
	// showItThen("with Clousre", function{
